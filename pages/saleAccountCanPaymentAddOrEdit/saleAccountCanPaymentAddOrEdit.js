...
Page({
  ...
  data: {
    ...
    loadModal:false,
    submitText:"提交",
    checkUrl:"../saleAccountCheckSelect/saleAccountCheckSelect",
    saleUrl:"../saleNotCheckList/saleNotCheckList",
  ...
  onSelectApply(){
    if(that.data.customer.id==null){
      ...
      if(that.data.saleUrl!=""){
        var url =that.data.saleUrl+"?customerId="+that.data.customer.id;
        wx.navigateTo({
          url:url
        })
      }
